...
// Simplified API surface required by pl/dependency. The Android port does
// not perform PE dependency scanning; these declarations exist so that
// NativeModManager.cpp compiles. Diagnostics return no issues.
